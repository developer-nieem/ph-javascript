...
let value = 102;
var output = centimeterToMeter(value);
console.log(output);
 */
...
let output = paperRequirements(2,3,20);
console.log('your page need', output);
 */
...
let friends = ['hasan', 'atikur rahman misba and mowlana', 'ismail hossen kuakata', 'merajsss'];
bestFriend(friends) */
